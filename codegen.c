...
// 类型映射表
// 有符号整型转换
static char i8f128[] = "  # i8转换为f128类型\n"
                       "  call __floatsitf@plt";

static char i16f128[] = "  # i16转换为f128类型\n"
                        "  call __floatsitf@plt";
...
// 无符号整型转换
static char u8f128[] = "  # u8转换为f128类型\n"
                       "  call __floatunsitf@plt";

static char u16f128[] = "  # u16转换为f128类型\n"
                        "  call __floatunsitf@plt";
...
static char *castTable[11][11] = {
    ...
    {NULL,   NULL,    NULL,    NULL,    i64u8,  NULL,    NULL,    NULL,    i64f32,  i64f64,  i8f128},  // 从i8转换
    {i64i8,  NULL,    NULL,    NULL,    i64u8,  i64u16,  NULL,    NULL,    i64f32,  i64f64,  i16f128}, // 从i16转换
    {i64i8,  i64i16,  NULL,    NULL,    i64u8,  i64u16,  i64u32,  NULL,    i64f32,  i64f64,  i32f128}, // 从i32转换
    {i64i8,  i64i16,  i64i32,  NULL,    i64u8,  i64u16,  i64u32,  NULL,    i64f32,  i64f64,  i64f128}, // 从i64转换

    {i64i8,  NULL,    NULL,    NULL,    NULL,   NULL,    NULL,    NULL,    u64f32,  u64f64,  u8f128},  // 从u8转换
    {i64i8,  i64i16,  NULL,    NULL,    i64u8,  NULL,    NULL,    NULL,    u64f32,  u64f64,  u16f128}, // 从u16转换
    {i64i8,  i64i16,  i64i32,  NULL,    i64u8,  i64u16,  NULL,    NULL,    u64f32,  u64f64,  u32f128}, // 从u32转换
    ...
    {f128i8, f128i16, f128i32, f128i64, f128u8, f128u16, f128u32, f128u64, f128f32, f128f64, NULL},    // 从f64转换
  ...
  case ND_FUNCALL: {
    ...
    for (Node *Arg = Nd->Args; Arg; Arg = Arg->Next) {
      ...
      case TY_UNION: {
        ...
        // 处理一或两个浮点成员变量的结构体
        if (isFloatOrDouble(Ty->FSReg1Ty) || isFloatOrDouble(Ty->FSReg2Ty)) {
          Type *Regs[2] = {Ty->FSReg1Ty, Ty->FSReg2Ty};
          for (int I = 0; I < 2; ++I) {
